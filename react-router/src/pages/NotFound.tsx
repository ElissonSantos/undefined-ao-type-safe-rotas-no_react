...
function NotFound() {
  ...
  return (
    <section className="font-display relative min-h-[70vh] overflow-hidden rounded-3xl bg-gradient-to-br from-amber-50 via-orange-100 to-red-100 p-8 shadow-xl ring-1 ring-orange-200/60 sm:p-12">
      <div
