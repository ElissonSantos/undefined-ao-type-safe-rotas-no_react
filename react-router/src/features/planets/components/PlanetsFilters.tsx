...
export default function PlanetsFilters() {
  const { response, filters, setFilters } = usePlanetsContext();
        ...
        <div className="md:col-span-5">
          <div className="relative group">
            ...
            <select
              ...
              value={
                filters.isDestroyed === undefined
                  ? ""
                  : filters.isDestroyed.toString()
              }
              onChange={(e) =>
                setFilters({
                  ...filters,
                  isDestroyed: e.target.value
                    ? e.target.value === "true"
                    : undefined,
                })
              }
            >
              ...
              <option value="true">Destruído</option>
              <option value="false">Não destruído</option>
            </select>
          </div>
        </div>
      </div>
